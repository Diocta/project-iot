...
import { Image, ScrollView, Switch, Text, TouchableOpacity, View, Alert } from "react-native";
            ...
            <TouchableOpacity style={styles.settingItem}>
              <View style={styles.settingLeft}>
                ...
                <View style={styles.settingTextContainer}>
                  ...
                  <Text style={styles.settingSubtitle}>Enable voice commands</Text>
                </View>
              </View>
              <Switch
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            ...
            <TouchableOpacity style={styles.menuItem}>
              <View style={styles.settingLeft}>
                <View style={[styles.settingIcon, { backgroundColor: '#E8F5E9' }]}>
                  <Ionicons name="shield-checkmark-outline" size={22} color="#66BB6A" />
                </View>
            ...
            <TouchableOpacity style={styles.menuItem}>
              <View style={styles.settingLeft}>
                <View style={[styles.settingIcon, { backgroundColor: '#E3F2FD' }]}>
                  <Ionicons name="help-circle-outline" size={22} color="#42A5F5" />
                </View>
            ...
            <TouchableOpacity style={styles.menuItem}>
              <View style={styles.settingLeft}>
                <View style={[styles.settingIcon, { backgroundColor: '#FFF9C4' }]}>
                  <Ionicons name="information-circle-outline" size={22} color="#FDD835" />
                </View>
